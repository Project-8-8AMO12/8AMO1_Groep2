...
<div class="container">
    ...
    <section class="mb-4">
        ...
        <!--Section description-->
        <p class="text-center w-responsive mx-auto mb-5">Nog enige vragen of andere opmerkingen? Laat het ons weten.</p>
        ...
        <div class="row">
            ...
            <div class="col-md-3 text-center">
                <ul class="list-unstyled mb-0">
                    <li>
                        <p>Leiden, Stationsweg 94A in Ede, Nederland</p>
                    </li><br>

                    <li>
                        <p>Telefonisch bereikbaar:<br>
                            0317-422 422 (van 10 - 14 uur)</p>
                    </li><br>

                    <li>
                        <p>Nog-Geen-Echt-email@gmail.com</p>
                    </li><br>
                </ul>
            </div>
            <!--Grid column-->
